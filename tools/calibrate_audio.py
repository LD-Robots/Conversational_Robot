#!/usr/bin/env python3
"""
Calibrare audio: reda un ton de test prin ec_speaker si inregistreaza ec_mic
pentru a estima leak-ul si pragul recomandat pentru barge-in.
...
def main():
    parser = argparse.ArgumentParser(description="Calibrare camera pentru barge-in.")
    ...
    print(f"RMS leak mic:   {leak_rms:.1f} dBFS  (D {leak_ratio:.1f} dB)")
    print(f"Low-band ratio (<200 Hz): {low_ratio*100:.1f}%")

    print("\n-------- Sugestii (editeaza configs/audio.yaml) --------")
